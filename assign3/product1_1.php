...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product1_1" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Lib Tech Cold Brew C2</p>
        </div>
        ...
        <div>
          ...
          <p id="product-code" class="product__value">SB-AM01</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">161cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">265mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">6.7kg</p>
        </div>
