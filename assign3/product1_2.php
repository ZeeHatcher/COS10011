...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product1_2" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Endeavor Maverick</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SB-AM02</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">165cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">259mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">6.2kg</p>
        </div>
