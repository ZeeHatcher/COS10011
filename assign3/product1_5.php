...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product1_5" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Nidecker Venus</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SB-FS02</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">155</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">249mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">6.54kg</p>
        </div>
