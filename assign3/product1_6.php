...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product1_6" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">GNU Klassy C2X</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SB-FS03</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">155cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">247mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">6.29kg</p>
        </div>
