...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product1_8" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Korua Shapes Pencil</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SB-PW02</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">269mm</p>
        </div>
