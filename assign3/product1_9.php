...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product1_9" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Bataleon Camel Toe</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SB-PW03</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">162cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">264mm</p>
        </div>
