...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product2_1" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Fischer Ranger</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SK-AM01</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">181cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">85mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">5.72kg</p>
        </div>
