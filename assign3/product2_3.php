...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product2_3" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">K2 Indy</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SK-AM03</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">124cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">70mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">4.27kg</p>
        </div>
