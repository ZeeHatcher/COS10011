...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product2_6" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Head Kore</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SK-FR03</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">189cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">107mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">7.31kg</p>
        </div>
