...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product2_7" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">DPS Yvette Alchemist</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SK-PW01</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">178cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">112mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">3.6kg</p>
        </div>
