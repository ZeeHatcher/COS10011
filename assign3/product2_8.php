...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product2_8" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Lib Tech Wreckcreate</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">SK-PW02</p>
        </div>

        <div>
          <h3 class="product__property">Size</h3>
          <p class="product__value">191cm</p>
        </div>

        <div>
          <h3 class="product__property">Thickness</h3>
          <p class="product__value">110mm</p>
        </div>

        <div>
          <h3 class="product__property">Weight</h3>
          <p class="product__value">4.54kg</p>
        </div>
