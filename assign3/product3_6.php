...
<body>
  ...
  <main>
    <section class="product">
      ...
      <div id="product3_6" class="card product__img"></div>

      <article class="product__details">
        <div>
          <h3 class="product__property">Name</h3>
          <p class="product__value">Snowset</p>
        </div>
        ...
        <div>
          ...
          <p class="product__value">2110g</p>
        </div>

        <div>
          <h3 class="product__property">Volume</h3>
          <p class="product__value">65 litres</p>
        </div>

        <div>
          <h3 class="product__property">Properties</h3>
          <ul class="product__value">
            <li class="bullet">Removable zip pockets</li>
            <li class="bullet">Padded shoulder straps</li>
            <li class="bullet">Roll top lid</li>
            <li class="bullet">Made from heat-sealed, waterproof PVC</li>
            <li class="bullet">Transparent side pocket</li>
          </ul>
        </div>
